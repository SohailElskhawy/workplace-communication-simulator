    ...
    variations: [
      {
        ...
        openingMessageAr:
          "ميعاد الجمعة متفقين عليه مع العميل ومفيش فيه تراجع، والإدارة متابعة الموضوع ده عن قرب. بتقول إن عندك قلق من الإطلاق—قول وجهة نظرك، بس خليك عارف إن التأجيل مش خيار مطروح إلا لو فيه مشكلة كارثية حقيقية.",
        counterpartBrief:
      ...
      },
      {
        ...
        openingMessageAr:
          "قبل ما ندخل في تفاصيل قلقك، خليني أوضحلك الأولويات من وجهة نظري: الإطلاق الأسبوع ده أهم لعلاقتنا بالعميل من الحالات النادرة اللي انت قلقان منها. اقنعني بقى إزاي المشاكل دي أهم من خسارة ثقة العميل.",
        counterpartBrief:
      ...
      },
      {
        ...
        openingMessageAr:
          "سامع كلامك وشايف إنك شايفنا مش جاهزين، بس أنا عندي معضلة: اتنين من زمايلك في إجازة الأسبوع ده، ومفيش أي ميزانية نجيب حد خارجي يساعد. أي حل هتقترحه لازم يتنفذ بالتيم الموجود حالياً. توصيتك إيه بالظبط؟",
        counterpartBrief:
      ...
      },
      {
        ...
        openingMessageAr:
          "قريت ملاحظتك مرتين، وبصراحة مش شايف الخطر الكبير اللي انت بتوصفه. الربع اللي فات حذرت من حاجة شبه كده وأطلقنا من غير أي مشاكل. اشرحلي إيه المختلف المرة دي بالظبط؟",
        counterpartBrief:
