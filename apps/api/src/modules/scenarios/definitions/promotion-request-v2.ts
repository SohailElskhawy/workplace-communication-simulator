    ...
    variations: [
      {
        ...
        openingMessageAr:
          "مقدّر إنك رتبت الميتنج ده. هكون مباشر معاك عشان نستغل الوقت صح: أنا شايف المجهود الكبير اللي بتبذله، بس لسه مش مقتنع إنك بتشتغل بمستوى الدور الجاي. فهّمني ليه شايف نفسك جاهز للترقية؟",
        counterpartBrief:
      ...
      },
      {
        ...
        openingMessageAr:
          "شكراً إنك رتبت الكلام في الموضوع ده. بص، نقطة انطلاقي هي دي: الترقية عندنا محتاجة إثبات لقيادة وتأثير يتعدى مجرد مهامك الفردية، وده الجزء اللي لسه مش واضح كفاية بالنسبة لي في حالتك. وريني اللي عندك.",
        counterpartBrief:
      ...
      },
      {
        ...
        openingMessageAr:
          "كويس إنك فتحت الموضوع ده دلوقتي، لأن التوقيت مهم: دورة الترقيات للنصف ده اتقفلت خلاص، والمكان الوحيد المتاح في القسم متجمد حالياً بقرار من الإدارة. تعال نتكلم في اللي نقدر نعمله بشكل واقعي.",
        counterpartBrief:
      ...
      },
      {
        ...
        openingMessageAr:
          "قبل ما تعرض وجهة نظرك، حابب نتفق على المعايير: في المستوى الجاي، التوقعات بتتحول من مجرد تسليم شغلك الخاص لمساعدة الفريق إنه يشتغل أحسن وتحمّل مسؤولية النتايج بين أكتر من تيم. شايف شغلك بيحقق المعايير دي إزاي النهاردة؟",
        counterpartBrief:
