  ...
  return (
    ...
    >
      <div className="border-b border-border/20 pb-3">
        ...
        <h2 className="font-display text-xl sm:text-2xl font-bold uppercase tracking-tight text-foreground mt-0.5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        {/* Situation */}
        <div className="rounded-control bg-surface-subtle p-4 border border-border/30 space-y-1.5 md:col-span-2">
          <div className="flex items-center gap-2">
            <AssignmentIcon className="w-4 h-4 text-primary shrink-0" />
            <span className="font-meta text-[11px] uppercase tracking-wider font-bold text-muted-foreground">
              Situation
            </span>
          </div>
        ...
        {/* Your Role */}
        <div className="rounded-control bg-surface-subtle p-4 border border-border/30 space-y-1.5">
          <div className="flex items-center gap-2">
        ...
        {/* Your Objective */}
        <div className="rounded-control bg-primary/5 p-4 border border-primary/20 space-y-1.5 md:col-span-2">
          <div className="flex items-center gap-2">
            <LightbulbIcon className="w-4 h-4 text-primary shrink-0" />
            <span className="font-meta text-[11px] uppercase tracking-wider font-bold text-primary">
        ...
        {context.stakes && (
          <div className="rounded-control bg-surface-subtle p-4 border border-border/30 space-y-1.5 md:col-span-2">
            <span className="font-meta text-[11px] uppercase tracking-wider font-bold text-muted-foreground block">
              Key Stakes
            </span>
